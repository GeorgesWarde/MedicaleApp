        ...
        <div class="container" style="margin-top:3%;">
            <div class="row align-items-start">
                <div class="col-sm-6 col-12">
                    <p><img src="public/uploads/<?= $row[27] ?>" width="100%" height="300px "
                            style="border-radius:8px;">
                    </p>
                    <p><img src="public/uploads/<?= $row[28] ?>" width="100%" height="300px" style="border-radius:8px;">
                    </p>
                </div>
                <div class="col-sm-6 col-12">
                    <p><img src="public/uploads/<?= $row[29] ?>" width="100%" height="300px" style="border-radius:8px;">
                    </p>
                    <p><img src="public/uploads/<?= $row[30] ?>" width="100%" height="300px" style="border-radius:8px;">
                    </p>
                </div>
            </div>
        </div>
