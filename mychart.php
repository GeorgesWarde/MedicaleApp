    ...
    <div class="mychart">
        <div class="container-xl">
            ...
            <div class="row" style="margin-top:30px ;">
                <div class="col-md-6">
                    <div class="imgtext">
                        <img src="https://www.bmc.org/themes/custom/bmc_base_theme/assets/images/icons/icon-mychart.svg" alt="">
                        <h3>My chart</h3>
                    </div>
                    <div class="text">
                ...
                <input type="checkbox" name="" id="accept" value="acceptTerms" style="transform:translateY(2px) ;" onclick="cbb()"></div>
                
                    <button disabled="disabled" class="btn btn-default btn-success" id="btn" onclick="location.href='login.php'">Sign up for my Chart</button><br><br>
