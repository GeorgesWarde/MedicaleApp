...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    ...
    <a href="/" class="d-flex align-items-center flex-shrink-0 p-3 link-dark text-decoration-none border-bottom">
      ...
      <span class="fs-5 fw-semibold">Appointments Schedules</span>
    </a>
  ...
  <label>Patient Name:</label>  <input style="border-radius:5px;width:300px;height:50px;margin-left:5px;" type="text" placeholder="Full Name">
    </div>
   
    <div class="form-floating inputs">Location:
    <select style="width:300px;border-radius:5px;height:50px;margin-left:40px;" name="location" id="locationMeeting"><option>Main Office</option></select>
    </div>
    <div class="form-floating inputs">
    Schedule Time:
    <select style="width:300px;border-radius:5px;height:50px;" name="location" id="locationMeeting"><option>8Pm</option></select>
  
    </div><div style="margin-top:10px;">
  <label>Duration:</label>  <input style="border-radius:5px;width:300px;height:50px;margin-left:40px;" type="text" placeholder="Duration">
    </div>
