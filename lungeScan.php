...
<body >
    ...
    <div class="col">
        <p style="justify-content:center;align-items:center;display:flex"><img src="Images/lungeScanA.jpg" width="70%" height="300px " style="border-radius:8px;"></p>
       
</div>
<div class="col">
<p style="justify-content:center;align-items:center;display:flex"><img src="Images/lungePicture2.jpg" width="70%" height="300px" style="border-radius:8px;"></p>
