      ...
      <div class="col table" style="overflow-x:auto ;">
        ...
        <form id="blood" method="post" enctype="multipart/form-data" style="display:none ;">
          ...
          <div class="row">
            <div class="col-md-6">
              eGFR(mL/min/1.73m*m):
              <input type="text" name="egfr" id="" style="width:100% ;" placeholder="eGFR(mL/min/1.73m*m)">
            </div>
            <div class="col-md-6">
              Corrected Calcium(mmol/L):
              <input type="text" name="calcium" id="" style="width:100% ;" placeholder="Corrected Calcium(mmol/L)">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="glucose" id="" style="width:100% ;" placeholder="Blood Glucose(mmol/L)">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              Phosphate(mmol/L):
              <input type="text" name="phosphate" id="" style="width:100% ;" placeholder="Phosphate(mmol/L)">
            </div>
            <div class="col-md-6">
              Magnesium(mmol/L):
              <input type="text" name="magnesium" id="" style="width:100% ;" placeholder="Magnesium(mmol/L)">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              Haemoglobin(g/L):
              <input type="text" name="haemoglobin" id="" style="width:100% ;" placeholder="Haemoglobin(g/L)">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              White Cell Count(x100000/L):
              <input type="text" name="white" id="" style="width:100% ;" placeholder="White Cell Count(x100000/L)">
            </div>
            <div class="col-md-6">
              Platelets(x100000/L):
              <input type="text" name="platelets" id="" style="width:100% ;" placeholder="Platelets(x100000/L)">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              Thyroid Stimulating Hormone(mIU/L):
              <input type="text" name="thyroid" id="" style="width:100% ;" placeholder="Thyroid Stimulating Hormone(mIU/L)">
            </div>
            <div class="col-md-6">
              Free triiodothyronine(T3)(PMOL/l):
              <input type="text" name="triiodothyronine" id="" style="width:100% ;" placeholder="Free triiodothyronine(T3)(PMOL/l)">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              Follicide stimulating hormone(mIU/mL):
              <input type="text" name="follicide" id="" style="width:100% ;" placeholder="Follicide stimulating hormone(mIU/mL)">
            </div>
            <div class="col-md-6">
              Testosterone(nmol/L):
