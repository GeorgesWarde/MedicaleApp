            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        ...
                        <i class="fa-solid fa-plus dash" ></i> <span class="ms-1 d-none d-sm-inline " >Add Labs Results</span> </a>
                        <ul class="collapse  nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="#" class="nav-link px-0" onclick="medShow()"> <span class="d-sm-inline">Add blood Test </a>
                            </li>
                            <li>
                                <a href="#" class="nav-link px-0"> <span class="d-sm-inline">Add Cranial CT Scan</a>
                            </li>
                            <li>
                                <a href="#" class="nav-link px-0"> <span class="d-sm-inline">Add Bone Dexa Scan</a>
                            </li>
                            <li>
                                <a href="#" class="nav-link px-0"> <span class="d-sm-inline">Add Lunges Scan</a>
                            </li>
                            <li>
                                <a href="#" class="nav-link px-0"> <span class="d-sm-inline">Add PCR</a>
                            </li>
                        </ul>
                    </li>
                    <li>
